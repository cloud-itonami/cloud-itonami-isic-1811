# Operator Quickstart — Community Printing Operations

Shortest path from clone to a verified local dry-run for **ISIC 1811** (`cloud-itonami-isic-1811`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1811.git
cd cloud-itonami-isic-1811
```
...
- Blueprint governor key: `printing-governor`
- Likely source path: `src/**/printing-governor.cljc`
